return require("cmake-tools").setup {
  ...
  --       ${kitGenerator}
  --       ${variant:xx}
  cmake_build_directory = "NVIM_BUILD/${variant:buildType}", -- this is used to specify generate directory for cmake, allows macro expansion
